...
if ($display) {
    if ($this->caching && $this->smarty->cache_modified_check) {
        ...
        if ((!$this->caching || $this->cached->has_nocache_code || $this->source->handler->recompiled)
            ...
            $output = $this->smarty->ext->_filterHandler->runFilter('output', ob_get_clean(), $this);
        } else {
            $output =  ob_get_clean();
        }
       ...
       if( !ctype_space($output) && !empty($output) ){  //not show empty templates
            $output  = "\r\n<!-- {START TEMPLATE src=".$this->source->filepath."} -->\r\n"
                .$output."\r\n<!-- {END TEMPLATE src="
