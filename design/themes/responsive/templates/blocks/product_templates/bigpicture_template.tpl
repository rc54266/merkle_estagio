            ...
            <div class="ty-product-bigpicture__left">
                <div class="ty-product-bigpicture__left-wrapper">
                    {hook name="products:main_info_title"}
                        {if !$hide_title}
                            <h3 class="ty-product-block-title" {live_edit name="product:product:{$product.product_id}"}><bdi>{$product.product nofilter}</bdi>
                            {debug}
                         <!--   {if $settings.hello_world.general.checkbox == 'Y'}
                            {$settings.hello_world.general.textfield}
                            {/if}
                            {$settings.hello_world.general.checkbox} -->
                          
                            </h3>
                            <h4> Descontos Disponíveis: <br>

                            <ul>
                            {foreach from=$settings.hello_world.general.multiselect key=key item=multiselect}
                                <li>{$key}%</li>
                            {/foreach}
                            </ul>
