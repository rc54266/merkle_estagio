...
<div class="cm-tabs-content">
    <div id="content_tab_new_profile{$id}">
        ...
        <div class="control-group">
            <label class="control-label" for="elm_field_read_only">read only:</label>
            <div class="controls">
            <input type="checkbox" id="elm_field_read_only" type="text" size="3" name="field_data[read_only]" value="{$field.read_only}" />
            </div>
        </div>
