<?php
/* Smarty version 4.1.0, created on 2023-03-23 19:57:09
  from 'C:\laragon\www\cscart\design\backend\templates\addons\incidents\views\incident\view.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_641c84e5698733_23410386',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4b34fe7327a8b5e01e16ca5396975c84c30fa567' => 
    array (
      0 => 'C:\\laragon\\www\\cscart\\design\\backend\\templates\\addons\\incidents\\views\\incident\\view.tpl',
      1 => 1679590625,
      2 => 'tygh',
    ),
  ),
...
function content_641c84e5698733_23410386 (Smarty_Internal_Template $_smarty_tpl) {
...
" class="ty-orders-search-options" name="orders_search_form" method="get">
            ...
            <div class="ty-control-group">
                <label class="ty-control-group__title"><?php echo $_smarty_tpl->__("order_status");?>
                                ...
                                <?php echo smarty_function_html_checkboxes(array('name'=>'status','options'=>$_smarty_tpl->tpl_vars['incident_status']->value),$_smarty_tpl);?>

            </div>
            <div class="buttons-container ty-search-form__buttons-container">
                <?php $_smarty_tpl->_subTemplateRender("tygh:buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('but_meta'=>"ty-btn__secondary",'but_text'=>$_smarty_tpl->__("storefront_search_button"),'but_name'=>"dispatch[incident.view]"), 0, false);
?>
            </div>
        </form>
        <table width="100%" class="table table-middle table--relative table-responsive table--overflow-hidden">
            <thead data-ca-bulkedit-default-object="true" data-ca-bulkedit-component="defaultObject">
                <tr>
                    ...
                    <th width="24%">
                    <a class="cm-ajax th-text-overflow  " href="" data-ca-target-id="pagination_contents"
                        title="Assigned to">Assigned to</a>
                </th>
            ...
            <tbody>
                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['all_incidents']->value, 'o');
...
?>
                    <tr class="cm-row-status-a cm-longtap-target cm-hide-inputs" data-ca-longtap-action="setCheckBox"
                        ...
                        <td width="8%" data-th="ID" class="table__first-column"><a
...
" class="row-status">
                        ...
                        <td width="30%" class="row-status wrap" data-th="Subject"><a
                                href="<?php echo htmlspecialchars(fn_url("incident.answer?incident_id=".((string)$_smarty_tpl->tpl_vars['o']->value['incident_id'])), ENT_QUOTES, 'UTF-8');?>
">
                            </a>
                            <strong><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['subject'], ENT_QUOTES, 'UTF-8');?>
                                                ...
                                                <td width="20%" class="row-status" data-th="create_Date">
...
"><bdi></bdi></a>
                        ...
                        <td width="18%" class="row-status" data-th="status_Name">
                            <a href="<?php echo htmlspecialchars(fn_url("incident.answer?incident_id=".((string)$_smarty_tpl->tpl_vars['o']->value['incident_id'])), ENT_QUOTES, 'UTF-8');?>
"><bdi></bdi></a>
                            <strong><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['status_name'], ENT_QUOTES, 'UTF-8');?>
</strong>
                        </td>
                        <td width="24%" class="row-status" data-th="operator">
                        <a href="<?php echo htmlspecialchars(fn_url("incident.answer?incident_id=".((string)$_smarty_tpl->tpl_vars['o']->value['incident_id'])), ENT_QUOTES, 'UTF-8');?>
"><bdi></bdi></a>
                        <strong><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['firstname'], ENT_QUOTES, 'UTF-8');?>
</strong>
                    </td>
                    </tr>
